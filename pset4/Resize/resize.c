...
int main(int argc, char* argv[])
{
    ...
    // verify n is is a positive int less than or equal to 100
    if(scale > 100 || scale < 1)
    {
        printf("Scale must be a positive integer less than or equal to 100\n");
        return 1;
    }
    ...
    // is there padding for scanlines?
    ...
    // allocate space for buffer to maintain scanline
    ...
    for (int i = 0, biHeight = abs(originalHeight); i < biHeight; i++)
    {
        ...
        // if applicable, skip over padding
        ...
        // write RGB triple to outfile
           for(int r = 0; r < scale; r++)
           {
                ...
                // adding in the padding into the outfiles
